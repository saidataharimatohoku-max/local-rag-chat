...
full = [
    ...
    "Added in-browser document upload with server-side validation and path-traversal protection, plus a 24-test pytest suite and GitHub Actions CI that runs fully offline.",
]
for b in full:
...
short = [
    ...
    "Delivered multi-format ingestion (PDF/DOCX/MD/TXT), streaming responses, secure in-browser upload, and a 24-test suite with GitHub Actions CI.",
]
for b in short:
    doc.add_paragraph(b, style="List Bullet")
...
doc.add_paragraph(
    "Built a local-first RAG document-Q&A app (FastAPI + Ollama, Azure-ready) "
    "with streaming responses, cited sources, multi-format ingestion, and "
    "CI-tested APIs.",
    style="List Bullet",
)
